...
#define SYS_CLKSEL_ADC_Pos			3		//ADC 时钟选择  0 HRC/4 for ADC, HRC/8 for SDADC	1 XTAL/8
...
#define ADC_CTRL_DMAEN_Pos			17		//RES2FF必须置1，DMA CH1 通过读取FFDATA寄存器读取转换结果
...
#define SDADC_CFG_REFM_Pos		    21		//在单端模式下选择负输入端：0 通道的N输入脚作为N输入端    1 公共的AINREFM引脚作为N输入端
